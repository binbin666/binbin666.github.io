...
MessageBox.prototype = {
    ...
    show: function(i, o, h, n, l) {
        ...
        if (!1 != this.params.Overlap || "yes" != i.attr("hasMessageBox")) {
            ...
            "over" == this.params.evType ? (i.bind("mouseleave", j.leftTimer), i.bind("mouseenter", j.incomingTimer), this.msgbox.bind("mouseenter",
            function() {
                clearTimeout(j.timer)
    ...
    _pos: function(e, f) {
        ...
        case "right":
            this.position.top = d.offset().top,
            this.position.left = d.offset().left + d.outerWidth() + this.params.margin
        }
...
window.bbFeedback = function() {
    ...
    function v(g, f, l, k, h) {
        f = {
            ...
            error: function() { (new MessageBox).show(g, "\u53d1\u9001\u5931\u8d25", 2000, "error")
            }
        };
    ...
    function u(E, D, C, B) {
        ...
        function() {
            ...
            $.ajax({
                url: utils.protocolRelative("//api.bilibili.com/x/v2/reply/report?jsonp=jsonp"),
                type: "post",
                data: {
                    oid: D,
                    type: 4 == C ? C: "arc" == C ? 1 : 2,
                    rpid: B,
                    reason: b,
                    content: d
                },
            ...
            }).fail(function() { (new MessageBox).show(c, "\u63d0\u4ea4\u5931\u8d25\uff0c\u8bf7\u91cd\u8bd5")
            }).complete(function() {
                c.css({
                    "background-color": "",
                    color: ""
        ...
        if (p) {
            ...
            for (var n = p.find(".reason-set").css({
                ...
                $('<label style="cursor:pointer;"><input style="vertical-align:middle; margin-top:2px; margin-right:5px;" type="radio" name="reason" value="' + (k + 1) % 9 + '"/><span style="vertical-align:middle;">' + E[k] + "</span></label>").css({
                    "vertical-align": "top",
                    width: "98px",
                    "line-height": "24px",
    ...
    function o(e, d, f) {
        ...
        this._parent.data("bbFeedback") || (this.fbID = ++j);
    ...
    window.CallPlayerAction = function(a) {
        ...
        case 1:
            ...
            if (0 == $("#review_comments_tips").length) {
                $('<div class="new_comm"><span id="review_comments_tips" tag="0"></span></div>').prependTo(a ? "#comment_container>ul": ".bilibili-comment > ul").on("click",
                function() {
                    window.feedback_object ? (window.feedback_object.orderby = "0", window.feedback_object.load(1)) : 0 < $("#fb_tp_id").length ? w($("#fb_tp_id").val(), 1) : 0 < $("#fb_aid").length ? y($("#fb_aid").val(), 1) : y($("#fb_news_id").val(), 1)
                })
            }
    ...
    o.prototype = {
        ...
        init: function() {
            ...
            $(f).off("scroll.bbFeedback-" + this.fbID).on("scroll.bbFeedback-" + this.fbID,
            function() {
        ...
        checkLogin: function(d) {
            if (this.loginInfo && $(".tg_send_post", this.target).length) {
                ...
                if (this.loginInfo.isLogin) {
                    return $(".user_face", d).removeClass("no-face"),
                    $(".user_face>img", d).attr("src", utils.thumbnail(this.loginInfo.face, 48)).show(),
                    d.find(".login-link-wrp").remove(),
                    UserStatus.checkMoral() ? this.loginInfo.level_info && 2 > this.loginInfo.level_info.current_level && this.loginInfo.officialVerify && -1 == this.loginInfo.officialVerify.type && window.uid && window.uid != window.mid && !(0 < this.loginInfo.vipType && 0 != this.loginInfo.vipStatus && 2 != this.loginInfo.vipStatus && 3 != this.loginInfo.vipStatus) ? (c.addClass("disabled"), $('<div class="login-link-wrp">\u60a8\u7684\u7b49\u7ea7\u4e0d\u8db3\uff0c\u5347\u7ea7\u81f3Lv2\u53ef\u53c2\u4e0e\u8bc4\u8bba</div>').prependTo($(".dcmp-textarea-container").addClass("disabled"))) : ($(".dcmp-textarea-container", d).removeClass("disabled"), c.removeClass("disabled"), $(".jc-notice", d).remove(), d.find(".ipt-txt").show()) : (c.addClass("disabled"), $('<div class="login-link-wrp">\u4f60\u7684\u8282\u64cd\u5df2\u4f4e\u4e8e60\uff0c\u5c06\u65e0\u6cd5\u53d1\u8868\u8bc4\u8bba\uff0c\u8be6\u60c5\u8bf7\u70b9\u51fb<a class="login-link b-btn" href="https://account.bilibili.com/site/record?type=moral" target="_blank">\u6211\u7684\u8282\u64cd\u8bb0\u5f55</a><a class="jc-help" href="//www.bilibili.com/html/help.html#j_4" target="_blank"><i class="b-tip jc"></i>\u5982\u4f55\u6062\u590d\u8282\u64cd\u503c\uff1f</a></div>').prependTo($(".dcmp-textarea-container").addClass("disabled"))),
                    !0
                }
                $(".user_face", d).addClass("no-face");
                $(".user_face>img", d).attr("src", "//static.hdslb.com/images/member/noface.gif");
                0 == d.find(".login-link").length && (c.addClass("disabled"), $('<div class="login-link-wrp">\u8bf7\u5148<a class="login-link b-btn" href="https://account.bilibili.com/login" target="_blank">\u767b\u5f55</a>\u540e\u53d1\u8868\u8bc4\u8bba (\u30fb\u03c9\u30fb)</div>').prependTo($(".dcmp-textarea-container").addClass("disabled")).find(".login-link").on("click",
                function(b) {
                    UserStatus.isLogin($(this), b)
                }));
                c.on("click.commentSubmitMsg",
                function() {
        ...
        initEmoji: function(g) {
            ...
            function(a) {
                g.find(".dcmp_post").find(a.target).length || 1 != l || (k.removeClass("open"), h.removeClass("open"), l = 0)
            });
            k.click(function() {
                0 == l ? ($(this).addClass("open"), h.addClass("open"), l = 1, $(".ipt-txt", g).focus()) : ($(this).removeClass("open"), h.removeClass("open"), l = 0)
            });
            h.on("click", ".emoji-wrap a",
            function() {
                UserStatus.isLogin(this) && (s($(".ipt-txt", g).get(0), $(this).text()), $(".ipt-txt", g).removeClass("error").parent().removeClass("error"), k.removeClass("open"), h.removeClass("open"), l = 0)
            });
            h.on("click", ".emoji-wrap span",
            function() {
                if (UserStatus.isLogin(this)) {
                    if (f.loginInfo.isLogin && 0 < f.loginInfo.vipType && 0 != f.loginInfo.vipStatus) {
                        1 == f.loginInfo.vipStatus ? (s($(".ipt-txt", g).get(0), $(this).attr("data-emoji-text")), $(".ipt-txt", g).removeClass("error").parent().removeClass("error"), k.removeClass("open"), h.removeClass("open"), l = 0) : 2 == f.loginInfo.vipStatus && $.ajax({
                            url: "//static.hdslb.com/vip/dist/js/vipPlugin.js",
                            cache: !0,
                            dataType: "script"
                        }).done(function() {
                            new window.vipDisable
                        })
                    } else {
                        ...
                        $(".b-vip-close", a).click(function(b) {
                            a = a.detach()
                        });
        ...
        bindAgree: function(b, f) {
            var e = this;
            if (f.action) {
                b.html("<span>\u5df2\u8d5e</span><b>(<em>" + f.like + "</em>)</b>").off("click").on("click",
                function() {
                    return x($(this), e.id, e.type, f.rpid, 0,
                    function() {
                        f.like--;
                        f.action = 0;
                        e.bindAgree(b, f)
                ...
                b.html("<span>\u8d5e</span><b>(<em>" + f.like + "</em>)</b>").off("click mouseenter.zan mouseleave.zan").on("click",
                function() {
                    return x($(this), e.id, e.type, f.rpid, 1,
                    function() {
                        f.like++;
                        f.action = 1;
                        e.bindAgree(b, f)
        ...
        recordToObject: function(k, h, A) {
            ...
            n = RegExp(/av([0-9]+)/g),
            l = RegExp(/@.+\.webp/i);
            1 == h.state ? ($('<a href="javascript:;">[\u6b64\u697c\u5c42\u5df2\u88ab\u7528\u6237\u9690\u85cf \u70b9\u51fb\u67e5\u770b]</a>').appendTo(k).click(function() {
                $(this).next().slideToggle(200)
            }), $('<div style="display:none" class="quote">' + z(h.content.message, h.content.members) + "</div>").appendTo(k)) : 3 == h.state || 4 == h.state ? $('<a href="javascript:;">***</a>').appendTo(k) : k.html(z(h.content.message, h.content.members));
        ...
        reply_render: function(e, d, l) {
            ...
            d.find(".re_ta").click(function() {
                k.re_send_show($(this).parents(".reply").find(".re_send"), $(this).parents(".re_cnt").find(".name").html(), e.rpid, e.root)
            });
            return d
        },
        loadReply: function(g, f, l, k) {
            ...
            $.ajax({
                ...
                success: function(b) {
                    ...
                    pagelist(g, k, Math.ceil(b.page.count / b.page.size), b.page.count,
                    function(c) {
                        h.loadReply(g, f, l, c)
                    },
        ...
        submitFeedback: function(E, D, C, B) {
            ...
            if (1000 < z.length || 3 > z.length) {
                return (new MessageBox).show(E, "\u8bf7\u53d1\u90013\u52301000\u5b57\u4e14\u975e\u7eaf\u8868\u60c5\u7684\u8bc4\u8bba", 3000, "error"),
                A.parent().addClass("error"),
                A.addClass("error").focus(),
                !1
            }
            var p = this,
            n, k; ! 1 !== C && (n = this._quoteID, k = this._rootQuoteID);
            C = {
                message: $("#comment_text", D).val(),
                parent: n,
                root: k || n,
                type: 1,
                plat: 1,
            ...
            C = {
                ...
                success: function(h) {
                    if (0 == h.code) {
                        A.val("");
                        if (h.data && 1 == h.data.is_pending) { (new MessageBox).show(E, "\u63d0\u4ea4\u6210\u529f", 2000);
                            return
                        } (new MessageBox).show(E, "\u53d1\u9001\u6210\u529f", 2000);
                        1 != p.page || ("0" != p.orderby || n || "function" == typeof B) || setTimeout(function() {
                            p.load(1)
                        },
                        200);
                        if (n) {
                            ...
                            b = parseInt(e.attr("data-page")),
                            g = parseInt(e.attr("data-results")) || a.children().length; (d.find(".re_more").length || b) && b != Math.ceil(g / 10) || setTimeout(function() {
                                p.loadReply(e, a, k || n, Math.ceil((g + 1) / 10))
                            },
                            200)
                        }
                        p.removeCaptcha();
                        ...
                        if (h) {
                            ...
                            case 12014:
                                ...
                                break;
                            case 12015:
                                D.find(".fb-vcode-wrp").length ? (d = "\u9a8c\u8bc1\u7801\u9519\u8bef", $("#fb_vcode").val(""), p.target.find(".tg_send_post .fb-vcode-wrp img").eq(0).click()) : d = "\u8bf7\u586b\u5199\u9a8c\u8bc1\u7801";
                            ...
                            default:
                                d = "\u53d1\u9001\u5931\u8d25"
                            } (new MessageBox).show(E, d, 3000, "error")
                        } else { (new MessageBox).show(E, "\u53d1\u9001\u5931\u8d25", 3000, "error")
                        }
                    }
                    h && h.data && (h.data.need_captcha ? h.data.url && p.createCaptcha(D, h.data.url) : (p.needCaptcha = !1, p.removeCaptcha()))
                },
                error: function() { (new MessageBox).show(E, "\u53d1\u9001\u5931\u8d25", 2000, "error")
                },
                complete: function() {
                    D.removeClass("state-sending")
                }
            };
        ...
        re_send_show: function(k, g, A, z, p) {
            ...
            if (0 == k.children().length) {
                ...
                }), $(".re_send", n.target).hide(), $(".re_send", n.target).children().remove(), $(".comm_send", n.target).html(), k.append(n.emojiDefault), n.checkLogin(k), k.find(".ywz").removeClass("open"), k.find(".biaoqing_box").removeClass("open"), k.show(), this.initEmoji(k), k.find(".ipt-txt").val(""), null != g && s($(".ipt-txt", k).get(0), "\u56de\u590d @" + g + " :"), $(".ipt-txt", k).hover(function() {
                ...
                }), $(".ipt-txt", k).bind("keyup",
                function() {
                    $(this).parent().removeClass("error");
                    $(this).removeClass("error")
                }), !this.loginInfo.isLogin) {
                    k.find(".login-link").off("click").on("click",
                    function(b) {
                        UserStatus.isLogin($(this), b)
                    })
                }
            } else {
                null != g ? (k.show(), k.find(".ipt-txt").val(""), s($(".ipt-txt", k).get(0), "\u56de\u590d @" + g + " :")) : "" == k.find(".ipt-txt").val() || k.parent().hasClass("empty") ? (g = 0 == l.find(".re_ul").children().length ? !0 : !1, "none" != k.css("display") ? (k.hide(), g && l.hide()) : (k.show(), g && l.show())) : k.find(".ipt-txt").val("")
            }
            $("button[type=submit]", k).off("click.submit").on("click.submit",
            function() {
        ...
        createCaptcha: function(f, e) {
            ...
            Captcha.setImage(h.find(".fb-vcode-wrp> img"), g,
            function(b) {
        ...
        createEmoji: function(G) {
            var F = {
                emoji: '<a>(\u2312\u25bd\u2312)</a><a>\uff08\uffe3\u25bd\uffe3\uff09</a><a>(=\u30fb\u03c9\u30fb=)</a><a>(\uff40\u30fb\u03c9\u30fb\u00b4)</a><a>(\u301c\uffe3\u25b3\uffe3)\u301c</a><a>(\uff65\u2200\uff65)</a><a>(\u00b0\u2200\u00b0)\uff89</a><a>(\uffe33\uffe3)</a><a>\u256e(\uffe3\u25bd\uffe3)\u256d</a><a>( \u00b4_\u309d\uff40)</a><a>\u2190_\u2190</a><a>\u2192_\u2192</a><a>(&lt;_&lt;)</a><a>(&gt;_&gt;)</a><a>(;\u00ac_\u00ac)</a><a>("\u2594\u25a1\u2594)/</a><a>(\uff9f\u0414\uff9f\u2261\uff9f\u0434\uff9f)!?</a><a>\u03a3(\uff9f\u0434\uff9f;)</a><a>\u03a3( \uffe3\u25a1\uffe3||)</a><a>(\u00b4\uff1b\u03c9\uff1b`)</a><a>\uff08/T\u0414T)/</a><a>(^\u30fb\u03c9\u30fb^ )</a><a>(\uff61\uff65\u03c9\uff65\uff61)</a><a>(\u25cf\uffe3(\uff74)\uffe3\u25cf)</a><a>\u03b5=\u03b5=(\u30ce\u2267\u2207\u2266)\u30ce</a><a>(\u00b4\uff65_\uff65`)</a><a>(-_-#)</a><a>\uff08\uffe3\u3078\uffe3\uff09</a><a>(\uffe3\u03b5(#\uffe3) \u03a3</a><a>\u30fd(`\u0414\u00b4)\uff89</a><a>(\u256f\u00b0\u53e3\u00b0)\u256f(\u2534\u2014\u2534</a><a>\uff08#-_-)\u252f\u2501\u252f</a><a>_(:3\u300d\u2220)_</a><a>(\u7b11)</a><a>(\u6c57)</a><a>(\u6ce3)</a><a>(\u82e6\u7b11)</a>',
                emoji_name: "\u989c\u6587\u5b57"
            },
            ...
            p = {
                ...
                slider: function(b) {
                    ...
                    n.css("left", -this.current * this.tabWidth)
                },
                renderDefault: function() {
                    n.append('<a class="emoji-tab tab-i on" data-pid="emoji"><img src="//static.hdslb.com/images/base/emoji-tab-default.png"></a>');
                    B.html(F.emoji)
                },
                ajaxEmojiRender: function(I) {
                    ...
                    if (I || !I.code || I.data.length) {
                        for (var a = 0; a < I.data.length; a++) {
                            if (h = "", k = I.data[a], l = k.emojis, $.isArray(l) && l.length && !k.pstate) {
                                null == p.firsrPid && (p.firsrPid = k.pid);
                                for (var b = 0; b < l.length; b++) {
                                    1 != l[b].state && (g = l[b], H = (g.name.split("_")[1] || "").slice(0, -1), h += '<span data-emoji-text="' + g.name + '"><img title="' + H + '" alt="' + g.name + '" data-id="' + g.id + '" data-state="' + g.state + '" data-img="' + utils.thumbnail(g.url, 40) + '"></span>')
                                }
                                F[k.pid] = h;
                                F[k.pid + "_name"] = k.pname || "";
                                $("<a>", {
                                    "class": "emoji-tab tab-i",
                                    "data-pid": k.pid,
                                    html: $("<img>", {
                                        "data-img": utils.thumbnail(k.purl, 22),
                                        alt: k.pname
                                    })
                                }).appendTo(n);
                                n.width(++p.total * p.tabWidth)
                            }
                        }
                        p.total > p.maxShow && (A.find(".tabs-wrap").append(z), z.on("click", ".prev.on",
                        function() {
                            p.slider( - 1)
                        }).on("click", ".next.on",
                        function() {
                        ...
                        G.find(".ywz").one("click",
                        function() { (new LazyImage({
                                mode: !1
                            })).lazy(n);
                            onLoginInfoLoaded(function(c) {
                                c.isLogin && (0 < c.vipType && 0 != c.vipStatus) && n.find('[data-pid="' + p.firsrPid + '"]').eq(0).trigger("click")
                            },
                            !0)
                        })
                    }
            ...
            $(document).on("click.vipmsg", ".emoji-vip-msg",
            function() {
                var b = $(this).siblings(".emoji-name").text();
                UserStatus.isLogin(this) && $.ajax({
                    url: "//static.hdslb.com/vip/dist/js/vipPlugin.js",
                    cache: !0,
                    dataType: "script"
                }).done(function() {
            ...
            if (!this.target.find(".comm_send").length) {
                ...
                var l = {
                    source: function(d, c) {
                        ...
                        $.getJSON("//interface.bilibili.com/m/friend_suggest?jsoncallback=?", {
                            term: m[1].replace(/\u3000/g, ""),
                            rnd: Math.random()
                        },
                        c)
                ...
                k;
                $(".ipt-txt", g).bind("keyup",
                function(b) {
                    $(this).removeClass("error").parent().removeClass("error"); (m = this.value.match(/@([^\s]*)$/)) ? (k = $(".ipt-txt", g).bilibiliSuggestion(l), $("#textarea_size_tester", g).get(0).innerText = this.value.substr(0, this.value.length - m[1].length)) : k && k.destroy()
                });
        ...
        load: function(E, D, C) {
            function p() {
                if (!e._loaded) {
                    d.addClass("b-load-fail").html("<span>\u52a0\u8f7d\u5931\u8d25\uff0c<a>\u70b9\u51fb\u91cd\u8bd5</a></span>").find("a").on("click",
                    function() {
                        e.load(E, D, C)
                    })
                }
            ...
            function f(g, c) {
                var b = e.target;
                if (12002 === g.code) {
                    e._sender.find(".submit-comment").off("click.commentSubmitMsg").addClass("disabled"),
                    e._sender.find(".login-link-wrp").remove(),
                    e._sender.find("#dcmp_textarea_container").addClass("disabled").prepend($('<div class="login-link-wrp">\u672c\u89c6\u9891\u8bc4\u8bba\u529f\u80fd\u5df2\u5173\u95ed</div>')),
                    d.remove()
                } else {
                    if (0 !== g.code || "object" != typeof g.data) {
                        p()
                    } else {
                        $(".common .b-head .results").html(g.data.page.acount).show();
                        D && g.data.page && (e.page = E = g.data.page.num);
                        e._loaded = !0;
                        __GetCookie("bbFrontManager") && UserStatus.isLogin() ? e.isAdmin = 2 : window.mid && window.uid && window.mid == window.uid ? e.isAdmin = 1 : UserStatus.isLogin() && (e.isAdmin = 0);
                        b.children().not(".comm_send").remove();
                        g.data.need_captcha ? (e.needCaptcha = !0, e.createCaptcha(b, g.data.url)) : (e.needCaptcha = !1, e.removeCaptcha());
                        var a = $('<div class="c_order"><ul class="b-slt-tab"><li order="0"><a>\u9ed8\u8ba4\u6392\u5e8f</a></li><li order="2"><a>\u6309\u8d5e\u540c\u6570</a></li><li order="1"><a>\u6309\u56de\u590d\u6570</a></li></ul></div>').prependTo(b);
                        $('li[order="' + e.orderby + '"]', a).addClass("on");
                        $("li", a).click(function() {
                            var z = $(this);
                            z.hasClass("on") || ($("li", a).removeClass("on"), z.addClass("on"), e.orderby = z.attr("order"), e.load(1))
                        });
                        var l = $('<ul class="comm_list"></ul>').appendTo(b),
                        n = $('<div class="pagelistbox"></div>').appendTo(b),
                        k = $('<div class="pagelistbox small"></div>').appendTo(a);
                        pagelist(n, E, Math.ceil(g.data.page.count / g.data.page.size), g.data.page.count,
                        function(z) {
                            e.load(z);
                            $(window).scrollTop($(e.target).offset().top + $(".z_top").outerHeight())
                        },
                        null, 2, !0);
                        "mobile" == e.platform && n.addClass("small");
                        pagelist(k, E, Math.ceil(g.data.page.count / g.data.page.size), g.data.page.count,
                        function(z) {
                            e.load(z)
                        },
                        null, 2);
                        g.data.replies.length && 0 != g.data.page.acount || $('<div class="no_more">\u6ca1\u6709\u66f4\u591a\u4fe1\u606f</div>').appendTo(l);
                        ...
                        for (n = 0; n < g.data.replies.length; n++) {
                            "object" == typeof g.data.replies[n] &&
                            function(B) {
                                if (B.member && B.content) {
                                    var L = "";
                                    B.member && B.member.official_verify && 0 == B.member.official_verify.type ? L = '<div class="legalize-16-1" style=\'position:absolute;top:50px;left:50px;\' title="\u4e2a\u4eba\u8ba4\u8bc1"></div>': B.member && (B.member.official_verify && 1 == B.member.official_verify.type) && (L = '<div class="legalize-16-2" style=\'position:absolute;top:50px;left:50px;\' title="\u4f01\u4e1a/\u56e2\u4f53\u8ba4\u8bc1"></div>');
                                    0 === B.root && B.content.message && (B.content.message = B.content.message.replace(/\[[^\[]*]/g,
                                    function(M) {
                                        return $("<img>", c[M]).prop("outerHTML") || M
                                    }));
                                    var J = $('<li id="l_id_' + B.rpid + '" class="main-floor"><div class="facebox"><a href="//space.bilibili.com/' + B.member.mid + '" target="_blank" mid="' + B.member.mid + '" card="' + B.member.uname + '"><img src="' + utils.thumbnail(B.member.avatar, 52, 52) + '" class="face"></a><a href="//space.bilibili.com/' + B.member.mid + '" mid="' + B.member.mid + '" target="_blank" class="face_bg" card="' + B.member.uname + '">' + (B.member.pendant && 0 < B.member.pendant.pid ? '<img src="' + utils.thumbnail(B.member.pendant.image, 86) + '" alt="' + B.member.pendant.name + '" />': "") + L + '</a></div><div class="t"><a href="//space.bilibili.com/' + B.member.mid + '" target="_blank" mid="' + B.member.mid + '" card="' + $("<div/>").text(B.member.uname).html() + '">' + $("<div/>").text(B.member.uname).html() + '</a><a href="//www.bilibili.com/html/help.html#k_3" target="_blank" class="user-info-level l' + (B.member.level_info ? B.member.level_info.current_level: 0) + '"></a>' + (B.member.nameplate && 0 < B.member.nameplate.nid ? '<a href="https://account.bilibili.com/site/nameplate" target="_blank" class="member-nameplate" nameplate-id="' + B.member.nameplate.nid + '"><img src="' + utils.thumbnail(B.member.nameplate.image_small, 32) + '" alt="' + B.member.nameplate.name + '" /></a>': "") + '</div><div class="content"></div><div class="elinfo"><span class="floor-num">#' + B.floor + "</span>" + (B.content.plat && 1 < B.content.plat ? '<span class="floor-plat">\u6765\u81ea<a href="//app.bilibili.com/" target="_blank">' + ("2" == B.content.plat ? "\u5b89\u5353\u5ba2\u6237\u7aef": "") + ("3" == B.content.plat ? "iOS\u5ba2\u6237\u7aef": "") + ("4" == B.content.plat ? "Windows Phone\u5ba2\u6237\u7aef": "") + "</a></span>": "") + '<span class="floor-date">' + t(B.ctime) + '</span></span><i class="report"></i></div></li>').appendTo(l);
                                    B.member.vip && (2 == B.member.vip.vipType && 0 != B.member.vip.vipStatus && 2 != B.member.vip.vipStatus) && J.find(".t > a").eq(0).addClass("b-vip-red");
                                    e.pushUser(B.member.mid, J);
                                    L = J.find(".content");
                                    e.recordToObject(L, B);
                                    if (null != B.replies) {
                                        for (var H = $('<div class="reply"><ul class="re_ul"></ul><div class="re_box">' + (5 < B.rcount ? '<p class="re_more"><span>\u8fd8\u6709<b>' + (B.rcount - 5) + '</b>\u6761\u56de\u590d\uff0c</span><a class="re_more_s">\u70b9\u51fb\u67e5\u770b</a></p>': "") + '<div class="re_page">   <div class="pagelistbox small">   </div></div></div><div class="re_send"></div></div>').appendTo(J), z = $(".re_ul", H), K = 1, L = 0; L < B.replies.length; L++) {
                                            e.reply_render(B.replies[L], B.rpid, z),
                                            D && (B.replies[L].rpid == D && g.data.page.rt_num) && (K = g.data.page.rt_num)
                                        }
                                        $(".re_more_s", H).click(function() {
                                            $(".re_more", H).remove();
                                            e.loadReply($(".pagelistbox", H), z, B.rpid, K)
                                        })
                                    }
                                    var L = J.find(".report"),
                                    I,
                                    G = $('<a href="javascript:;" class="huifu">\u56de\u590d</a>').appendTo(L).click(function() {
                                        0 == J.find(".reply").length ? (I = $('<div class="reply"><ul class="re_ul"></ul><div class="re_box"><p class="j_re"><a class="re_send_s" href="javascript:;">\u53c2\u4e0e\u56de\u590d</a></p><div class="re_page"> <div class="pagelistbox"></div></div></div><div class="re_send"></div></div>').appendTo(J), $(".re_box", I).hide(), $(".re_send_s", I).click(function() {
                                            e.re_send_show(I.find(".re_send"), null, B.rpid)
                                        })) : I = J.find(".reply");
                                        I.find(".re_ul");
                                        e.re_send_show(I.find(".re_send"), null, B.rpid)
                                    });
                                    B.replies && B.replies.length && G.addClass("reply-b").text("\u53c2\u4e0e\u56de\u590d");
                                    0 <= e.isAdmin && ($('<a class="jubao">\u4e3e\u62a5</a>').appendTo(L).click(function() {
                                        return u(this, e.id, e.type, B.rpid)
                                    }), e.bindAgree($('<a href="javascript:;" class="zan"></a>').prependTo(L), B));
                                    1 == e.isAdmin && (G = $('<a href="javascript:;" title="\u88ab\u9690\u85cf\u540e\uff0c\u5176\u4ed6\u7528\u6237\u4f1a\u9ed8\u8ba4\u4e0d\u663e\u793a\u8be5\u8bc4\u8bba" class="no hidefb">\u9690\u85cf\u8be5\u8bc4\u8bba</a>').appendTo(L).click(function() {
                                        v(this, h, e.type, B.rpid, !0);
                                        return ! 1
                                    }), L = $('<a href="javascript:;" class="yes showfb">\u663e\u793a\u8be5\u8bc4\u8bba</a>').appendTo(L).click(function() {
                                        v(this, h, e.type, B.rpid, !1);
                                        return ! 1
                                    }), 0 == B.state || 6 == B.state || 2 == B.state ? L.hide() : G.hide())
                                }
                            } (g.data.replies[n])
                        }
                        e.checkFeed(e.id);
                        "pc" == e.platform && (bindCardEvent(b), bindNameplateEvent(b));
                        "function" == typeof C && C(b);
                        e.options.useIframe && r();
                        e._trigger("onLoad")
                    }
                }
            }
            ...
            E = this.page;
            var e = this,
            F = 4 == e.type ? 4 : "topic" == e.type ? 2 : 1,
            A = i.base + i.list.getReply + "?jsonp=jsonp&type=" + F + "&sort=" + e.orderby + "&oid=" + e.id + "&pn=" + E + "&r=" + Math.random() + "&nohot=1";
            D && (A = i.base + i.list.getPosition + "?jsonp=jsonp&rpid=" + D + "&type=" + F + "&oid=" + e.id + "&pn=" + E + "&r=" + Math.random() + "&nohot=1");
            this.target.find(".b-loading").remove();
            if (!e._loaded) {
                var d = $('<div class="b-loading"></div>').appendTo(this.target)
            }
            $.when($.ajax({
                dataType: "jsonp",
                url: A
                ...
                url: "//api.bilibili.com/x/v2/reply/emojis",
                dataType: "jsonp",
                data: {
                    jsonp: "jsonp"
                },
                cache: !0,
                jsonpCallback: "jsonp_z_emoji"
            })).done(function(l, k) {
                var H = {},
                G = k[0];
                if (G && !G.code && G.data.length) {
                    for (var B = 0; B < G.data.length; B++) {
                        var z = G.data[B].emojis;
                        if ($.isArray(z) && z.length) {
                            for (var n = 0; n < z.length; n++) {
                                H[z[n].name] = {
                                    "class": "b-vip-emoji",
                                    title: (z[n].name.split("_")[1] || "").slice(0, -1),
                                    src: utils.thumbnail(z[n].url, 50),
                                    alt: z[n].name
                                }
                            }
                        }
                ...
                onLoginInfoLoaded(function(b) {
                    1 === b.vipStatus && e.emojiXHR.resolve(G)
                },
                !0);
                f(l[0], H)
            })
        ...
        show: function(g, f, l, k) {
            ...
            if (!this.options.autoLoad || l) {
                $("#load_comment").remove(),
                $(this.target).show(),
                this.createCommentSender(),
                this.load(f, l, k)
            } else {
                if (this._checkAutoLoad()) {
                    this.load(f, l, k)
                } else {
                    $(window).on("scroll.comment-autoload",
                    function() {
...
function attentionUser(e, f, d) {
    ...
    Bilibili.attentionUser(e, f,
    function(a) { - 665 == a.code ? $.getScript("//static.hdslb.com/plugins/attentionLimitPopup/attentionLimitPopup.js",
        function() {
...
function showSpAdbtn(f, h, e) {
    ...
    if ((h = void 0 !== h ? h: window.spid) || e) {
        "1" == f ? (g = $('<p class="b-btn w">\u5df2\u8ba2\u9605</p>').on("click",
        function() {
            void 0 !== e ? Subscribe.bangumi(this, e, !1,
            function() {
                showSpAdbtn("0", h, e)
            }) : Subscribe.sp(this, h, !1,
            function() {
                showSpAdbtn("0", h, e)
            })
        }), g.hover(function() {
        ...
        function() {
            g.html("\u5df2\u8ba2\u9605")
        })) : g = $('<p class="b-btn dy">\u8ba2\u9605</p>').on("click",
        function() {
            void 0 !== e ? Subscribe.bangumi(this, e, !0,
            function() {
                showSpAdbtn("1", h, e)
            }) : Subscribe.sp(this, h, !0,
            function() {
                showSpAdbtn("1", h, e)
            })
        }),
...
var Subscribe = {
    ...
    _toggle: function(h, l, g, k, j) {
        if (UserStatus.isLogin(l)) {
            var i = this; ("bangumi" == h ? $.get("/api_proxy?app=bangumi", {
    ...
    _fail: function() { (new MessageBox).show(btn, "\u8bf7\u6c42\u53d1\u751f\u9519\u8bef(\u00b4\u30fb\u03c9\u30fb\uff40)", 1500, "error")
    }
};
...
var Bilibili = {
    ...
    badlistUser: function(e, f, d) {
        ...
        postJSON({
            url: "//" + Bilibili.interface_domain + "/m/friend_manage.do",
            data: {
                act: "add_badlist",
                format: "json",
                uid: f
...
function sendCommand(h, l, g, k, j) {
    var i = j || "\u547d\u4ee4\u6267\u884c\u6210\u529f";
    return (new MessageBox).show(h, l, "button",
    function(a) {
        $.ajax({
            url: g,
            data: k,
            type: "POST",
            dataType: "html",
            success: function(c) { (new MessageBox).show(h, "OK" == c ? i: c, "OK" == c ? 500 : 2000, "OK" == c ? "info": "warning")
            },
            error: function() { (new MessageBox({
                    Overlap: !0,
                    position: a.position
...
var UserCard = function() {
    function E(b) {
        "top" == j.attr("direction") ? F.css("top", j.offset().top - F.outerHeight() + 40 + "px") : F.css("top", (0 < j.parents(".upinfo").length ? -80 : 0) + j.offset().top + "px");
        j.offset().left + $(".a-layer").outerWidth() + j.width() + 5 > $(window).width() ? F.css("left", j.offset().left - 13 - $(".a-layer").outerWidth() + "px") : F.css("left", j.offset().left + j.width() + 13 + "px");
    ...
    function C(a) {
        clearTimeout(u);
        G && ($(".a-layer").remove(), F = $('<div class="a-layer"><div class="content"><div class="bg_top"></div><div class="msg">' + a + "</div></div></div>").appendTo("body"), E())
    }
    function D(d) {
        var c = d.data.card;
        d = d.data.space;
        clearTimeout(u);
        G && "undefined" == typeof c.mid ? C("\u62b1\u6b49\uff0c\u8be5\u6635\u79f0\u76ee\u524d\u4e0d\u5b58\u5728\u54e6(*^__^*)") : (c.top_photo = "//i0.hdslb.com/bfs/static/c9dae917e24b4fc17c4d544caf6b6c0b17f8692b.jpg", d && d.s_img && (c.top_photo = d.s_img), B(c))
    }
    function B(a) {
        if (G) {
            i[a.name] = a;
            ...
            var h = "";
            if ("\u7537" == a.sex || "\u5973" == a.sex) {
                h = '<i class="b-icon sex ' + ("\u7537" == a.sex ? "male": "\u5973" == a.sex ? "female": "") + '" title="' + a.sex + '" ></i>'
            }
            var g = "",
            e = a.sign;
            ...
            F = $('<div class="a-layer">' + (a.pendant && a.pendant.image ? '<a href="https://account.bilibili.com/site/face" target="_blank" class="user-pendant"></a>': "") + '<div class="content main"><div class="user-top-photo" style="background-image:url(' + utils.trimHttp(a.top_photo) + ');background-position: center;background-size: cover;"></div><a class="user-face" href="//space.bilibili.com/' + a.mid + '" target="_blank"><img src="' + utils.thumbnail(a.face, 52) + '" /></a>' + g + '<div class="layer-row"><a class="user-name" href="//space.bilibili.com/' + a.mid + '" target="_blank">' + a.name + "</a>" + h + '<a href="//www.bilibili.com/html/help.html#k_4" target="_blank" class="user-info-level border l' + a.level_info.current_level + '"></a></div><div class="layer-row"><a class="layer-link" href="//space.bilibili.com/' + a.mid + '/#!/fans/follow/1" target="_blank">\u5173\u6ce8\uff1a' + a.attention + '</a><a class="layer-link" href="//space.bilibili.com/' + a.mid + '/#!/fans/fans/1" target="_blank">\u7c89\u4e1d\uff1a' + a.fans + "</a></div>" + (e ? '<div class="layer-row sign">' + e + "</div>": "") + '</div><div class="layer-bottom"><span href="javascript:void(0);" class="layer-follow-btn b-btn"></span><a class="layer-message-btn b-btn-cancel" href="//message.bilibili.com/#whisper/mid' + a.mid + '" target="_blank">\u79c1\u4fe1</a></div></div>').appendTo("body");
            F.find(".layer-follow-btn").html(A(a));
            a.vip && (2 == a.vip.vipType && 0 != a.vip.vipStatus && 2 != a.vip.vipStatus) && F.find("a.user-name").addClass("b-vip-red");
            E(a.pendant)
        } else {
            i[a.name] = a
        }
    ...
    function A(h) {
        ...
        p = !1,
        n, l = function() {
            F.find(".layer-follow-btn").html(A(h))
        };
        ...
        })) : (n = $('<a href="javascript:;">+\u5173\u6ce8</a>'), n.on("click",
        function() {
    ...
    function y(b, c) {
        ...
        i[c] ? (clearTimeout(u), B(i[c])) : $.ajax({
            url: "//api.bilibili.com/cardrich",
            dataType: "jsonp",
            data: {
                mid: c,
                type: "jsonp"
    ...
    function w(b) {
        "undefined" != typeof b ? $(b).find("a[card]").mouseenter(function() {
            $(this).text() && -1 != $(this).text().indexOf("@") || x(this, $(this).attr("mid"))
...
function bindPOCoins2(w, u) {
    ...
    i = function() {
        ...
        r = setTimeout(function() {
            if (b.attr("data-view") && "loaded" != b.attr("data-view")) {
                j(b, "//www.bilibili.com/widget/ajaxGetVideoInfo?aid=" + b.attr("data-view"))
            } else {
                if (1 == s) {
                    $(".ov-box").remove();
    ...
    w.each(function(b, l) {
        ...
        if (v(k, "gk") || k.attr("data-view")) {
            if ($(l).parents(".rlist").length && k.hover(i, n), "undefined" === typeof u || !1 !== u) {
                c = parseInt(v(k, "yb")),
                2000 <= c && 10000 > c ? h = 200 : 10000 <= c && (h = 300),
                h && (k.hasClass("v") ? k.addClass("m" + h) : k.find(".v").addClass("m" + h))
            }
        }
    })
}
...
var UserStatus = function() {
    return {
        ...
        quickLogin: function(b, d) {
            ...
            d && d.preventDefault(); ! browser.version.mobile || browser.version.iPad ? RequireModule.getScript("biliQuickLogin", "https://static-s.bilibili.com/account/bili_quick_login.js",
            function() {
                window.biliQuickLogin(function() { ! 1 !== b ? setTimeout(function() {
                        loadLoginStatus(!0);
                        "function" == typeof b && b()
                    },
...
function loadLoginInfo(f, h) {
    ...
    f.isLogin || RequireModule.getScript("biliQuickLogin", "https://static-s.bilibili.com/account/bili_quick_login.js",
    function() {
        $("#i_menu_login_btn a.login").on("click",
        function(b) {
            b.preventDefault();
    ...
    for (e = 0; e < loginCallbacks.length; e++) {
        loginCallbacks[e](f),
        f.isLogin && (loginCallbacks.splice(e, 1), e--)
    }
}
function onLoginNavigator(h) {
    if ($(".z_top").length) {
        if (h.isLogin) {
            var l, g = 0;
            for (l in h.dynamic) {
                g += parseInt(h.dynamic[l])
            }
            h.dynTotalNum = g; ! $("#i_menu_community_msg_btn").length && $("#i_menu_msg_btn").length && $('<li id="i_menu_community_msg_btn" guest="no" i_menu="community_msg" class="u-i">                <a class="i-link" href="//message.bilibili.com" target="_blank">\u6d88\u606f</a>            </li>').insertAfter("#i_menu_profile_btn");
            $('li[guest="no"]').show();
            $('li[guest="yes"]').hide();
            ...
            $("#i_menu_become_vip").click(function() {
                rec_rp("event", "nav_getvip")
            });
            g = $("#i_menu_profile");
            l = {
                1 : "\u5927\u4f1a\u5458",
            ...
            var k = "";
            1 != h.vipType && 2 != h.vipType || 1 != h.vipStatus ? $("#i_menu_become_vip a").hide() : ($("#i_menu_become_vip a").text("\u5927\u4f1a\u5458"), $.ajax({
                url: "//static.hdslb.com/phoenix/dist/js/bubble.min.js",
                dataType: "script",
                cache: !0
            }));
            ...
            h.level_info && 0 < h.level_info.current_level && 1 <= h.money ? (l = String(h.money).split("."), l = 2 === l.length ? (h.money - 1).toFixed(l[1].length) : h.money - 1, $(".coin", g).html('<b class="b-back"></b><b class="b-icon"></b><div class="outside"><div class="pre">' + l + '</div><div class="cur">' + h.money + '<span class="reward-for-login">&nbsp;\u767b\u5f55\u5956\u52b1</span></div></div>')) : $(".coin", g).html('<b class="b-icon"></b>' + h.money);
            ...
            RequireModule.getScript("messageModule",
            function() {
                messageModule.load()
            });
...
function loadLoginStatus(f) {
    ...
    try {
        window.sessionStorage && (h = window.sessionStorage.bili_login_status) && (h = JSON.parse(h)) && (new Date).getTime() < h[0] && (!__GetCookie("DedeUserID") && void 0 === h[3] || parseInt(__GetCookie("DedeUserID"))),
        e()
    } catch(g) {
        e()
    }
...
$.fn.smoothScroll = function(e, f) {
    ...
    this.init = function(g) {
        var c = this;
        c.isFF ? g.addEventListener("DOMMouseScroll",
        function(a) {
...
var ToolTips = function() {
    ...
    b.prototype = {
        ...
        show: function(s, r, q, p) {
            ...
            if (!this.visible) {
                ...
                j = n.offset().top,
                c = n.offset().left,
                i = this.tip = $('<div class="' + this.className + '"><div class="tip-arrow"></div><div class="tip-text"></div></div>'); ! 0 === p && (p = $("<div>").addClass("close").html("\u00d7").on("click",
                function() {
                    i.fadeOut(200,
                    function() {
                        o.remove()
        ...
        remove: function() {
            this.animation ? this.tip.fadeOut(300,
            function() {
                $(this).remove()
            }) : this.tip.remove();
            this.visible = !1
    ...
    return {
        ...
        bind: function(j, a, i, h) {
            var g = this; ("undefined" != typeof j && j ? "undefined" != typeof $(j).attr("tips") ? $(j) : $("[tips]", j) : $("[tips]")).each(function(f, e) {
                e = $(e);
...
function profileWnd(D) {
    ...
    if (B.length) {
        ...
        D.pendant && D.pendant.image ? ($("<img>", {
            "class": "i_face-pendant hide",
            src: utils.trimHttp(D.pendant.image),
            alt: D.pendant.name
        }).insertAfter(A), A.addClass("has_pendant")) : A.removeClass("has_pendant");
        var u = $(".i_face-pendant"),
        v = function() {
            var d = [],
            c = new Date;
        ...
        function() {
            ...
            C.is(":visible") || (A.addClass("scale-in"), b[c] == v() && y.removeClass("hover-first").addClass("hover-again"), C.stop().slideDown(200,
            function() {
                u.removeClass("hide");
                $(".legalize-icon", B).show();
                b[c] != v() && D.mobile_verified && (b[c] = v(), utils.localStorage.setItem("time_tracker", JSON.stringify(b)), $("#i_menu_profile .info a.linkToCurrency").addClass("off"), setTimeout(function() {
                    $("#i_menu_profile .info a.linkToCurrency").removeClass("off").addClass("on")
                },
                3000), y.removeClass("hover-again").addClass("hover-first"))
            }))
        },
        function() {
            u.addClass("hide");
        ...
        w = D.level_info;
        s = $('<a class="help-link" href="//www.bilibili.com/html/help.html#k" target="_blank">\u4f1a\u5458\u7b49\u7ea7\u76f8\u5173\u8bf4\u660e ></a>');
        ...
        var i = $('<div class="user-info-desc"><span class="arrow-left"></span><div class="lv-row">\u4f5c\u4e3a<strong>LV' + w.current_level + "</strong>" + (0 == w.current_level ? "\uff0c\u4f60\u65e0\u6cd5\u4eab\u53d7\u7279\u6743": "\uff0c\u4f60\u53ef\u4ee5\uff1a") + "</div><div>" + "\u6210\u4e3a\u6b63\u5f0f\u4f1a\u5458\uff0c\u4f60\u53ef\u4ee5\uff1a<br/>1\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55<br/>2\u3001\u53c2\u4e0e\u89c6\u9891\u8bc4\u8bba<br/>3\u3001\u767b\u5f55\u83b7\u5f97\u786c\u5e01<br/>4\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf 1\u3001\u53d1\u5c04\u6eda\u52a8\u5f39\u5e55<br/>2\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf<br/>3\u3001\u5386\u53f2\u64ad\u653e\u4e0a\u9650\uff1a100 1\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55\uff08\u5f69\u8272\u3001\u9ad8\u7ea7\uff09<br/>2\u3001\u53c2\u4e0e\u89c6\u9891\u4e92\u52a8\uff08\u8bc4\u8bba\uff09<br/>3\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf<br/>4\u3001\u5386\u53f2\u64ad\u653e\u4e0a\u9650\uff1a120 1\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55\uff08\u5f69\u8272\u3001\u9ad8\u7ea7\u3001\u9876\u90e8\u3001\u5e95\u90e8\uff09<br/>2\u3001\u53c2\u4e0e\u89c6\u9891\u4e92\u52a8\uff08\u8bc4\u8bba\u3001\u6dfb\u52a0tag\uff09<br/>3\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf<br/>4\u3001\u5386\u53f2\u64ad\u653e\u4e0a\u9650\uff1a150 1\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55\uff08\u5f69\u8272\u3001\u9ad8\u7ea7\u3001\u9876\u90e8\u3001\u5e95\u90e8\uff09<br/>2\u3001\u53c2\u4e0e\u89c6\u9891\u4e92\u52a8\uff08\u8bc4\u8bba\u3001\u6dfb\u52a0tag\uff09<br/>3\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf<br/>4\u3001\u5386\u53f2\u64ad\u653e\u4e0a\u9650\uff1a200 1\u3001\u8d2d\u4e70\u9080\u8bf7\u7801\uff081\u4e2a/\u6708\uff09<br/>2\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55\uff08\u5f69\u8272\u3001\u9ad8\u7ea7\u3001\u9876\u90e8\u3001\u5e95\u90e8\uff09<br/>3\u3001\u53c2\u4e0e\u89c6\u9891\u4e92\u52a8\uff08\u8bc4\u8bba\u3001\u6dfb\u52a0tag\uff09<br/>4\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf<br/>5\u3001\u5386\u53f2\u64ad\u653e\u4e0a\u9650\uff1a200 1\u3001\u8d2d\u4e70\u9080\u8bf7\u7801\uff082\u4e2a/\u6708\uff09<br/>2\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55\uff08\u5f69\u8272\u3001\u9ad8\u7ea7\u3001\u9876\u90e8\u3001\u5e95\u90e8\uff09<br/>3\u3001\u53c2\u4e0e\u89c6\u9891\u4e92\u52a8\uff08\u8bc4\u8bba\u3001\u6dfb\u52a0tag\uff09<br/>4\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf<br/>5\u3001\u5386\u53f2\u64ad\u653e\u4e0a\u9650\uff1a200".split(" ")[w.current_level] + "</div></div>").hide().appendTo(E);
        j.mouseenter(function(b) {
            clearTimeout(o);
            i.stop(!0, !0).fadeIn(200)
        }).mouseleave(function(b) {
            o = setTimeout(function() {
                i.stop(!0, !0).fadeOut(200)
            },
            300)
        });
...
function initDynWnd(j) {
    ...
    if (0 != i.length) {
        ...
        j = {
            ...
            append: function(D) {
                ...
                case 1:
                    ...
                    B = utils.trimHttp(F.pic);
                    A = F.author;
                    r = 'card="' + F.author + '" mid="' + F.mid + '"';
                    z = "<span>\u6295\u7a3f\u4e86</span>";
                    y = F.title;
                    t = "//space.bilibili.com/" + F.mid;
                    s = utils.trimHttp(F.link);
                    C = " v";
                    break;
                case 3:
                    B = utils.trimHttp(D.source.cover);
                    A = D.source.title;
                    z = "<span>\u66f4\u65b0\u4e86</span>";
                    G = '<span class="sp">\u756a\u5267</span>';
                    y = F.title;
                    t = "//bangumi.bilibili.com/anime/" + D.source.season_id + "/";
                    s = utils.trimHttp(F.link);
                    break;
                case 5:
                    B = utils.trimHttp(D.source.cover);
                    ...
                    break;
                case 6:
                    B = utils.trimHttp(D.source.avatar),
                    A = D.source.uname,
                    r = 'card="' + D.source.uname + '" mid="' + D.source.mid + '"',
                    z = "<span>\u53d1\u8868\u4e86\u8bc4\u8bba</span>",
                    y = D.content.msg,
                    t = "//space.bilibili.com/" + D.source.mid,
                    s = utils.trimHttp(F.link + D.content.flink),
                    C = " u"
                }
                return $('<li class="d-data"><div class="preview' + C + '"><img src="' + utils.trimHttp(B) + '" /></div><div class="r"><div class="title">' + (G ? G: "") + E + '<a href="' + t + '"' + ("" != r ? r: "") + ' target="_blank">' + A + "</a>" + z + '</div><div class="info"><a href="' + s + '" target="_blank" title="' + (6 != D.type ? y: F.title) + '">' + y + "</a></div></div></li>")
            },
            onData: function(d) {
        ...
        $.ajax({
            url: "//api.bilibili.com/x/feed/unread/count",
            data: {
                jsonp: "jsonp"
            },
            dataType: "jsonp",
...
MiniWnd.prototype = {
    ...
    get: function(e) {
        ...
        if ("undefined" == typeof e.loading || 1 != e.loading) {
            e.loading = 1,
            "undefined" == typeof e.data ? $.get(utils.protocolRelative(e.url), e.reqData || {},
            function(a) {
                e.loading = 0;
                if (0 == a.code) {
                    d.remove(),
                    ...
                    d.html("<a>\u6570\u636e\u83b7\u53d6\u5931\u8d25,\u70b9\u51fb\u91cd\u8bd5</a>").find(">a").one("click",
                    function() {
                        f.get(e)
                    })
                }
...
function initMiniWnd() {
    ...
    if (UserStatus.status().isLogin) {
        ...
        if (g.length) {
            var i = {
                ...
                render: function(n, f) {
                    ...
                    q.empty();
                    for (var o in p) {
                        "object" == typeof p[o] && (null != p[o].title ? $('<li><a href="//www.bilibili.com/video/av' + p[o].aid + '" target="_blank" title="' + p[o].title + '">' + p[o].title + "</a></li>") : $('<li><a href="//www.bilibili.com/mylist' + p[o].lid + '" target="_blank" title="' + p[o].description + '">' + p[o].description + "</a></li>")).appendTo(q)
                    }
        ...
        k.length && (g = {
            wnd: $('<div class="mini-wnd"><ul class="list history"></ul><a class="read-more" href="//www.bilibili.com/account/history" target="_blank">\u67e5\u770b\u66f4\u591a<i class="b-icon b-icon-arrow-r"></i></a></div>'),
            ...
            render: function(z, y) {
                ...
                for (c in w) {
                    if ("object" == typeof w[c]) {
                        var B = h(new Date(1000 * w[c].view_at)),
                        a = h(new Date(1000 * (w[c].view_at + 86400)));
                        if (1 != l(B, o)) {
                            var o = B,
                            C = $('<li class="timeline"><span class="date"></span></li>').appendTo(x);
                            1 == l(B, v) ? C.find(".date").html("\u4eca\u65e5") : 1 == l(a, v) ? C.find(".date").html("\u6628\u65e5") : C.find(".date").html((new Date(1000 * w[c].view_at)).format("yyyy-MM-dd hh:mm:ss"))
                        }
                        if (null != w[c].title) {
                            var A = $('<li><a href="//www.bilibili.com/video/av' + w[c].aid + '" target="_blank" title="' + w[c].title + '">' + w[c].title + "</a></li>")
                        }
                        A.appendTo(x)
                    }
                }
...
function initLiveDyn() {
    ...
    i.find("li").click(function() {
        "live" == $(this).attr("mode") ? (j.find(".wnd_bottom").not(".live").hide(), l.show()) : (j.find(".wnd_bottom").not(".live").show(), l.hide())
    });
    var l = $('<div class="wnd_bottom live"><div class="r-l"><a class="btn-live-more" href="//live.bilibili.com/i/following" target="_blank">\u6240\u6709\u5173\u6ce8</a></div></div>').insertAfter(o).hide(),
    k = new dynManage(n);
        ...
        b.finish ? b.complete() : (b.page++, b.data[b.params.pageKey] = b.page, b.setLoading(1), $.ajax({
            ...
            success: function(j) {
                if (0 == j.code) {
                    ...
                    b.setLoading(0); ! i || !i.length || 0 != a || b.num >= b.getResults(j) ? b.complete() : b.target.is(":visible") && b.target.height() - b.getLoading().elem.height() < b.wrapper.height() && b.load()
                } else {
                    b.accessError()
                }
            },
        ...
        var d = {
            ...
            init: function() {
                ...
                if ("object" == typeof b) {
                    ...
                    this.options.onData = this.options.onData ||
                    function() {
                    ...
                    if (!1 !== this.options.autoLoad) {
                        if (this.options.wrapper.on("scroll",
                        function() {
                            a.scroll()
                        }), "number" == typeof this.options.autoLoad) {
                            this.options.state.on("click",
                            function() {
            ...
            showPage: function() {
                ...
                this._trigger("onShowPage", $(h.pageContainer), g, Math.ceil(this.totalPage / h.showPageAfter), this.totalResults,
                function(a) {
                    f.num = 0;
                    f.autoNum = 0;
                    f.manualLoad = !0;
        ...
        xhrParams: function() {
            ...
            return {
                ...
                success: function(a) {
                    ...
                    0));
                    0 != g.page % c.showPageAfter && 1 !== c.showPageAfter || g.manualLoad ? $(c.pageContainer).hide() : (g.waitManualOperate = !0, c.state.hide()); (0 == g.page % c.showPageAfter || g.page >= a.numPages || 1 === c.showPageAfter) && 1 < g.showPages && ($(c.pageContainer).show(), g.showPage())
                }
            }
        }
    });
        ...
        if ("banner" == F) {
            if (0 < $(".header .logo").length) {
                ...
                v = $('<div class="bili_live_pmt" b-stat="float-pmt-banner" b-stat-v="' + x[1] + '"><a href="' + x[1] + '" target="_blank"></a></div>').css({
                    ...
                    height: A || 80,
                    "margin-top": -20,
                    background: "url(" + utils.trimHttp(x[0]) + ") no-repeat",
        ...
        if (! ($("#a_ds_" + D).length || j && parseInt(j.split(",")[0]) == D && j.split(",")[1] && (new Date).getTime() < parseInt(j.split(",")[1]))) {
            ...
            if (i.length) {
                var I = $("<a>").addClass("float-pmt").attr({
                    ...
                    position: "absolute",
                    right: -F,
                    top: $(window).scrollTop() + $(window).height() - i.offset().top - H - 220,
                    height: H,
                    width: F,
                    "z-index": 10050
                });
                $("<img />").attr("src", utils.trimHttp(x[0])).css({
                    width: "100%",
                    height: "100%",
                    display: "block"
                }).appendTo(I);
                ...
                I.appendTo(i);
                $(window).on("scroll.bili-float-ads",
                function() {
                    I.css("top", $(window).scrollTop() + $(window).height() - i.offset().top - H - 220)
                });
                return I
            }
        }
...
function biliShowAds(w, u, v, t, s) {
    ...
    try {
        ...
        "i" == n[0] ? $('<a id="a_ds_' + u + '" data-id="' + q + '" data-loc-id="' + o + '" href="' + n[3] + '" target="_blank"><img src="' + utils.trimHttp(v ? n[2] : n[1]) + '"' + s + ' border="0" /></a>').appendTo(t) : $('<embed id="a_ds_' + u + '" wmode="opaque" pluginspage="//www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" allowscriptaccess="none" rel="noreferrer" src="' + (v ? n[2] : n[1]) + '"' + s + ' type="application/x-shockwave-flash" allowfullscreen="true" quality="high">').appendTo(t);
        $(t).show()
    } catch(i) {}
}
...
var Responsive = {
    ...
    init: function(e) {
        ...
        for (var d = 0; d < this.screenWidthArr.length; d++) {
            this.pageCss.push("b-page-" + this.pageWidthArr[d]),
            $(document).width() >= this.screenWidthArr[d] && (f = this.pageWidthArr[d])
        }
    ...
    reset: function(b) {
        ...
        for (var d = 0,
        d = 0; d < this._callbacks.length; d++) {
            this._callbacks[d](b)
        }
    }
};
...
var SelectModule = function() {
    ...
    b.prototype.init = function() {
        ...
        f.on("click.selectMenu",
        function(c) {
            h._tap(c)
        });
        this._isMobile || !1 === this.params.hover || (f.on("mouseenter.selectMenu",
        function(c) {
            h._mover(c)
        }), f.on("mouseleave.selectMenu",
        function(c) {
            h._mout(c)
        }));
    ...
    b.prototype._mout = function(c) {
        ...
        this.list.hide();
        this._active = !1; (this._isMobile || !1 === this.params.hover) && $(document).off("click.selectMenu")
    };
    ...
    b.prototype.select = function(e, f) {
        this._mout(e);
        if (!f || this._change(f)) {
            "undefined" == typeof f && (f = this.value()),
            this.change(f, e)
        }
    };
...
function IndexNavigator(b) {
    ...
    this.mergeConfig(b);
    $.isArray(this.config.nav) || (this.config.nav = $.map(this.config.nav,
    function(d, c) {
...
IndexNavigator.prototype = {
    ...
    init: function() {
        ...
        for (e = 0; e < this.config.nav.length; e++) {
            if (f = this.config.nav[e].id, !this.config.block || this.config.block[f]) {
                this.nameMap[f] = this.configMap.length,
                this.configMap.push(f),
                this.seq.push(f)
            }
        }
    ...
    createNavigator: function() {
        ...
        if (this._isIndex || this.config.appIcon) {
            ...
            i = new Animator({
                ...
                frameSource: "//i0.hdslb.com/bfs/static/e6f2388d454c82004905753802e9cfe709d80d08.png",
                frameWidth: 80,
                frameHeight: 80,
                totalFrame: 16
            }),
    ...
    renderNavItem: function() {
        ...
        for (var f = null,
        h = 0; h < this.config.nav.length; h++) {
    ...
    initCustomize: function() {
        ...
        i.customContainer.click(function(a) {
            a.stopPropagation();
            i.customizing ? j() : (i.pointer.hide(), o.is(":visible") || o.appendTo("body").stop().hide().fadeIn(), "undefined" != typeof i.tipWnd && i.tipWnd.fadeOut(200,
            function() {
                i.tipWnd.remove()
...
window.Captcha = {
    ...
    _load: function() {
        ...
        if (this._tryTime > b._maxTryTime) {
            ...
            this._xhr = $.ajax({
                ...
                async: this.async,
                success: function(a) {
                    window.captcha_key = b.value = a;
                    for (var e = b._tryTime = 0; e < b._query.length; e++) {
                        if (b._query[e] && b._query[e][0]) {
                            b._query[e][0](a)
                        }
                    }
                    b._query = []
    ...
    updateImage: function(f, h, e) {
        ...
        return $(f).removeAttr("src").attr({
            width: 100,
            height: 50,
            src: utils.trimHttp(h),
            title: "\u70b9\u51fb\u5237\u65b0\u9a8c\u8bc1\u7801"
        }).off("click.captcha").on("click.captcha",
        function() {
...
var LazyImage = function() {
    function b(d) {
        this.config = {
            distance: 200,
            defaultImg: "//static.hdslb.com/images/v3images/img_loading.png",
            mode: "wrap"
        };
    ...
    b.prototype.show = function() {
        for (var e = 0; e < this.covers.length; e++) {
            ...
            f = c.element,
            c = c.callback;
            f.attr("loaded") || ("wrap" != this.config.mode || f.parent(".img-loading").length ? "wrap" != this.config.mode && f.attr("src", utils.trimHttp(this.config.defaultImg)) : (f.attr("src", "//static.hdslb.com/images/transparent.gif"), f.wrap(this.wrapper).parent().css({
                background: "#f5f5f5 url(//static.hdslb.com/images/v3images/img_loading.png) center center no-repeat",
                height: "100%"
    ...
    b.prototype.load = function(u, t) {
        function s() {
            if ("//www.bilibili.com/" == location.href || "https://www.bilibili.com/" == location.href || "//www.bilibili.com/account/dynamic" == location.href || "https://www.bilibili.com/account/dynamic" == location.href) {
                0 < r.list.length && $.ajax({
                    url: "//data.bilibili.com/v/void/web_pic_ld_time",
                    type: "get",
                    data: {
        ...
        function() {
            ...
            u.css("opacity", 0).animate({
                opacity: 1
            },
            a);
            50 <= r.list.length && s();
            clearTimeout(r.shuttle);
            r.shuttle = setTimeout(function() {
                s()
            },
            3000)
        });
...
SliderController.prototype = {
    ...
    init: function() {
        ...
        d.dataSrc && (0 == $(d.parent).find(".p-loading").length && this.loading.appendTo(this.wrapper), "function" == typeof d.dataSrc ? $.getJSON(d.dataSrc(),
        function(a) {
            b.loading.remove();
            b.load(a)
        }) : "string" == typeof d.dataSrc ? $.getJSON(d.dataSrc,
        function(a) {
            b.loading.remove();
            b.load(a)
    ...
    f.prototype = {
        ...
        init: function() {
            ...
            this.options.target.on("keydown." + c,
            function(a) {
                switch (a.keyCode) {
                case 38:
                    g._move(a, "up");
        ...
        render: function(a) {
            ...
            this.options.disabled || !a || e.isArray(a) && !a.length || this.cancelSearch || !1 === this._trigger("response", a) ? this._close() : (this._open(), this._renderMenu(this.$container, a), /AppleWebKit.*Mobile.*/i.test(navigator.userAgent) || e("<iframe></iframe>").css({
                ...
                border: 0,
                frameborder: "no"
            }).appendTo(this.$container), this.elements = this._getMenuItem(), this.elements.on("mousedown",
            function(b) {
                b.preventDefault();
                g.cancelBlur = !0;
                g._delay(function() {
        ...
        _normalize: function(a) {
            return ! e.isArray(a) || a.length && a[0].label && a[0].value ? a: e.map(a,
            function(c) {
        ...
        _focus: function(g) {
            var c = this.selectedItem.data("item"); ! 0 === this._trigger("focus", g, {
                item: c
...
FakeDanmu.prototype = {
    ...
    load: function(b) {
        if (this.loadState == FakeDanmu.READY) {
            ...
            var d = this;
            $.getJSON("/widget/ajaxGetComment?aid=" + b,
            function(c) {
...
function addReturnToMobile() {
    if (browser.version.mobile && !browser.version.iPad) {
        $('<div class="goto-mobile"><div class="bg"></div></div>').appendTo("body").on("click",
        function() {
            __SetCookie("nmr", 0);
...
Animator = function(b) {
    function d(a) {
        ...
        a.element.css({
            display: "block",
            backgroundImage: "url(" + utils.trimHttp(a.frameSource) + ")",
            width: a.frameWidth,
...
GlobalView = {
    ...
    randomPromotion: function() {
        ...
        i,
        j;
        $.get("//www.bilibili.com/index/index-icon.json",
        function(d) {
            ...
            if (j && j.link) {
                ...
                if ("bilibili\u7ed9\u60a8\u62dc\u5e74\u5566" == j.title) {
                    var c = "//static.hdslb.com/activity/bnj2016/img/fire1.gif",
                    a = $(),
                    l = $("<div>").css({
                        left: 0
                    }).append($("<img>").css({
                    ...
                    function() {
                        e = !0;
                        b.css("cursor", "url(//static.hdslb.com/activity/bnj2016/img/fire2.ico), pointer");
                        g = setTimeout(function() {
                            a.appendTo(".header .menu-wrapper").css({
                                position: "absolute",
                                overflow: "hidden",
                                top: -10,
                                zIndex: 20000,
                            ...
                            l.css("left", -(l.width() - 50)).find("img").attr("src", utils.trimHttp("//static.hdslb.com/activity/bnj2016/img/fire4.gif"));
                            h.css("right", -(l.width() - 50)).find("img").attr("src", utils.trimHttp("//static.hdslb.com/activity/bnj2016/img/fire3.gif"));
                            0 > l.offset().left && l.width(parseInt($(".header .menu-wrapper").offset().left + 50)).css("left", -(l.width() - 50));
                            h.offset().left + h.width() > $(window).width() && h.width(parseInt($(window).width() - $(".header .menu-wrapper").offset().left - $(".header .menu-wrapper").outerWidth() + 50)).css("right", -(l.width() - 50))
                        },
                        100)
                    }).on("mouseleave",
                    function() {
    ...
    nav: function() {
        ...
        e = {
            ...
            stream: "//live.bilibili.com/bili/live_hover",
            travel: "//www.bilibili.com/page-proxy/yoo-nav.html"
        };
        h.find("[hasframe]").on("mouseenter.frame",
        function() {
            var b = $(this),
            d = b.find("[data-frame]");
        ...
        if (!$(".z_top").hasClass("b-header-blur") && !$("#searchform, #search_frm, #header-search").length) {
            ...
            this.initSearch(g, $.extend(!0, window.suggestionOpt, {
                form: g.find("form"),
                css: {
                    minWidth: 188,
                    maxWidth: 360
        ...
        hoverDelay(h.find(".shouji"),
        function() {
            h.find(".shouji .mobile-p-box").show()
        },
        function() {
            h.find(".shouji .mobile-p-box").hide()
        },
        300)
    },
    menu: function() {
        ...
        $(".header .nav-menu").find(".m-i-square").on("mouseenter",
        function() {
            var f = $(this),
            a = f.find(".i_num"),
            e;
            a.attr("data-initialized") ? b(a) : ($.getJSON("//api.bilibili.com/plaza/banner?callback=?",
            function(h) {
                if (0 == h.code && h.result && h.result.length) {
                    ...
                    for (e = 0; e < h.result.length; e++) {
                        var c = h.result[e];
                        $('<div class="square-pmt-item"><a href="' + c.link + '" target="_blank"><img src="' + utils.trimHttp(c.cover) + '"></a></div>').appendTo(d).attr("title", c.title)
                    }
                    b(a)
                }
    ...
    notice: function(e) {
        if (e) {
            ...
            $("<div>").addClass("n-toggle").append('<i class="n-close"></i><i class="b-icon b-icon-notice"></i>').on("click",
            function() {
    ...
    initSearch: function(g, j, f) {
        ...
        function() {
            ...
            if ("" == b && h.attr("data-recommend")) {
                ...
                if ("" == b) {
                    return window.open("//search.bilibili.com", i.attr("target")),
                    !1
                }
            }
            SearchHistory.save(h.val())
        });
        f && $.getJSON("//www.bilibili.com/widget/getSearchDefaultWords",
        function(b) {
...
$(function() {
    ...
    $("body").on("mouseover.fakedanmu", ".v .preview",
    function() {
    ...
    }).on("mouseout.fakedanmu", ".v .preview",
    function() {
        var b = $(this).closest(".v").find("a").attr("href").match(/av(\d+)/);
        b && FakeDanmu.pause({
            width: 180,
    ...
    if ("undefined" != typeof countInfo) {
        for (var h, l, g = 0,
        k = 0,
        j = 0; j < tidSet.length; j++) {
            if (h = tidSet[j], l = countInfo["c" + h]) {
                k += l,
                $(".addnew_" + h).html(999 >= l ? l: "999+")
            }
        }
    ...
    var i = window.suggestionOpt = {
        ...
        select: function(e, d) {
            ...
            if (d.item.url) {
                return "click" != e.type && window.open(d.item.url, i.submitTarget || "_blank"),
                !1
            }
            var f;
        ...
        renderItem: function(n, f) {
            ...
            case "accurate":
                ...
                case "special":
                    ...
                    break;
                case "topic":
                    q.addClass("topic").find(".type").html("\u8bdd\u9898"),
                    q.find(".sub").html("\u53d1\u5e03\uff1a" + f.writer),
                    $('<div class="pubdate">\u65f6\u95f4\uff1a' + (new Date(1000 * f.pubdate)).format("yyyy-MM-dd") + "</div>").insertAfter(q.find(".t"))
                }
                break;
            case "upuser":
...
function createSuggestUserList(i) {
    ...
    for (o in suggest_user) {
        if (h++, !("undefined" != typeof i && h <= i)) {
            ...
            if (!k && (k = $('<li><a href="//space.bilibili.com/' + l[0] + '" mid="' + l[0] + '" target="_blank" card="' + l[1] + '"><img src="' + utils.trimHttp(l[2]) + '"><div class="name">' + l[1] + '</div></a><p class="i"><a class="gz">\u5173\u6ce8</a></p><div class="info">' + l[3] + "</div></li>").appendTo("#rup_user").find(".gz"),
            function(d, c) {
                c.click(function() {
                    1 == c.attr("attention") ? unattentionUser(c, d,
                    function() {
...
function insertFlash(f, h, e, g) {
    document.getElementById(f) && (h = '<embed height="' + g + '" width="' + e + '" id="' + f + '_flash" pluginspage="//www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" allowscriptaccess="always" style="visibility:hidden"  src="' + h + '" type="application/x-shockwave-flash" allowfullscreen="true" quality="high">', document.getElementById(f).innerHTML = h)
}
var cb_controler;
...
function loadNotify() {
    "http:" == document.location.protocol && ($('<div id="cb_controler"></div>').appendTo("body"), insertFlash("cb_controler", "//static.hdslb.com/images/bili_notify.swf", 0, 0), cb_controler = $("#cb_controler_flash").get(0))
}
var searchKW = "",
lastPage = "";
function searchAT() {
...
$(document).ready(function() {
    ...
    if (utils.isBeta([4, 8])) {
        ...
        function(a) {
            a = a.target;
            var f = $(a).attr("href"),
            c; ("link-ranking" === a.className || $(".link-ranking").find(a).length) && $(".link-ranking").attr("href", b);
...
$(document).ready(function() {
    function f() {
        ...
        0 > e ? (clearTimeout(g), g = setTimeout(function() {
            f()
        },
        3000)) : h()
    }
    function h() {
        $.ajax({
            url: "//data.bilibili.com/v/void/web_ld_time",
            type: "get",
            data: {
                mid: __GetCookie("DedeUserID"),
                info_type: "home_ld",
    ...
    if (void 0 != window.pageLoadStart) {
        var e, g;
        if ("//www.bilibili.com/" == location.href || "https://www.bilibili.com/" == location.href || "//www.bilibili.com/account/dynamic" == location.href || "https://www.bilibili.com/account/dynamic" == location.href) {
            window.performance && window.performance.timing ? f() : (e = (Date.now ? Date.now() : (new Date).getTime()) - pageLoadStart, h())
        }
    }
});