...
> <p>目前，越来越多的企业应用会部署在 Linux 系统上的，而 Linux Shell 脚本可以极大地帮助我们完成这些应用的运维任务。这使得 Linux Shell 开发技能成为开发人员的一项重要的、有竞争力的技能。本文就笔者的实际开发经验，以 Korn Shell 为例分享了脚本开发中的常见问题及相关技巧。</p>
